...
shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    textInput("searchTerm", "Enter the hashtag to retrive tweets", "#"),
    sliderInput("maxTweets","Number of recent tweets to retrive for analysis:",min=10,max=1000,value=300), 
    submitButton(text="Submit & Analyse")
